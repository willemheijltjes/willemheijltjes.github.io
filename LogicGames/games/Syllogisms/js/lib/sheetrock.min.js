!function (e, t) {
    ...
    return function (e) {
        ...
        function o() {
            function e(e) {
                if (e && "SheetrockError" === e.name && o && o.update && o.update({failed: !0}), t.callback)return void t.callback(e, n, s);
                if (e)throw e
            }

            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, n = null, o = null, s = null;
            try {
                n = new i.default(a({target: this}, t), !!r), o = new l.default(n), s = new c.default(o)
            } catch (t) {
                e(t)
            }
        ...
        var a = Object.assign || function (e) {
                ...
                return e
            }, s = r(1), i = n(s), u = r(5), l = n(u), f = r(6), c = n(f), d = r(2), p = r(8), h = n(p), y = "1.1.4";
        a(o, {defaults: d.defaults, version: y});
        try {
        ...
        function i(e) {
            var t = {};
            if (t.target = (0, d.extractElement)(e.target), t.fetchSize = Math.max(0, parseInt(e.fetchSize, 10) || 0), !t.target && !e.callback && !c.defaults.callback)throw new h.default("No element targeted or callback provided.");
        ...
        function u(e, t) {
            ...
            if (Object.keys(c.sheetTypes).forEach(function (t) {
                ...
                return {key: n, gid: e.url.match(r.gidFormat)[1], apiEndpoint: r.apiEndpoint.replace("%key%", n)}
            }
        ...
        var l = Object.assign || function (e) {
                ...
                return e
            }, f = r(2), c = o(f), d = r(3), p = r(4), h = n(p), y = function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            a(this, e), this.user = i(s(t)), this.request = u(this.user, r), this.requestIndex = this.request.key + "_" + this.request.gid + "_" + this.user.query
        };
        ...
        var a = function (e) {
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                r(this, t);
                var a = n(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
        ...
        var a = Object.assign || function (e) {
            ...
            defaults: {failed: !1, header: 0, labels: null, loaded: !1, offset: 0},
            store: {}
        }, f = function () {
            function e(t) {
            ...
            return s(e, [{
                ...
                key: "state", get: function () {
                    var e = {}.hasOwnProperty.call(l.store, this.index), t = this.options.user.reset || this.options.request.data;
                    if (!e || t) {
                        var r = {labels: e ? l.store[this.index].labels : null};
                        l.store[this.index] = a({}, l.defaults, r)
                    }
                    return l.store[this.index]
                }
            }, {
                key: "url", get: function () {
                    var e = this.options.user.fetchSize, t = e ? " limit " + (e + 1) + " offset " + this.state.offset : "", r = ["gid=" + encodeURIComponent(this.options.request.gid), "tq=" + encodeURIComponent(this.options.user.query + t)];
        ...
        var s = function () {
        ...
        }(), i = r(7), u = o(i), l = r(4), f = o(l), c = r(3), d = n(c), p = function () {
            function e(t) {
            ...
            return s(e, [{
                key: "setAttributes", value: function () {
                    var e = this.options.user.fetchSize, t = this.raw.table.rows, r = this.raw.table.cols, n = {
                        last: t.length - 1,
                    ...
                    })), (!e || t.length - n.rowNumberOffset < e) && (n.last += 1, this.request.update({loaded: !0}));
                    var a = this.options.user.labels, s = a && a.length === o.length;
                    n.labels = s ? a : o, this.attributes = n
                }
            }, {
                key: "setOutput", value: function () {
                    var e = this;
                ...
                key: "setHTML", value: function () {
                    var e = this.options.user.target, t = this.options.user.rowTemplate || d.toHTML, r = d.isTable(e), n = e && d.hasClass(e, "sheetrock-header"), o = "", a = "";
                ...
                key: "loadData", value: function (e, t) {
                    ...
                    try {
                        ...
                        return void t(new f.default("Unexpected API response format."))
                    }
                    this.setHTML(), t(null)
                }
            }]), e
        ...
        function o(e, t) {
            ...
            var a = window.document.createElement("script"), l = "_sheetrock_callback_" + u;
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = r(4), s = n(a), i = window.document.getElementsByTagName("head")[0], u = 0;
        t.default = o, e.exports = t.default
    }])
});
